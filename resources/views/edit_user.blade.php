										...
										<div class="ibox-content">
											<div class="row">
												<div class="col-sm-12 b-r">
													...
													<form role="form" method="POST" action="{{url('/proses/user/edit')}}" >
														@foreach ($data1 as $user)
														<div class="form-group">
															<label>Nama</label> 
															<input type="text" name="nama"  placeholder="Nama Lengkap" value="{{$user->nama}}" class="form-control">
														</div>
														<div class="form-group">
															<label>Role</label> 
														...
														<div class="form-group">
															...
															<input type="hidden" name="id_user" value="{{$user->id}}" class="form-control">
														</div>
